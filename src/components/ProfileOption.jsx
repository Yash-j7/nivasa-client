  ...
  return (
    <div className="flex-none gap-2">
      <div className="dropdown dropdown-end">
        <label
          tabIndex={0}
          className="btn btn-ghost btn-circle avatar hover:outline-0 hover:border-0"
        >
        ...
        <ul
          tabIndex={0}
          className="mt-3 z-[999999999] bg-[#fff] font-heading p-2 shadow menu menu-sm dropdown-content rounded-md w-52 "
        >
          <li>
            <Link
              to={"/profile"}
              className="justify-start text-brand-blue hover:text-brand-blue"
            >
