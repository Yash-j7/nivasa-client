        ...
        <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
          <div className="max-w-xl text-center sm:text-left">
            ...
            <p className="mt-4 max-w-md sm:text-md font-content text-white">
              Discover a place you'll love to call home. Browse our curated
              listings tailored to your needs and lifestyle. We're here to make
              your home-buying journey simple, exciting, and stress-free.
            </p>
